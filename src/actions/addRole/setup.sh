...
action_presets() {
    printf '%s\n' addRole installFlake network boot disk encryption
}

action_config() {
    nds_cfg_preset_set_display addRole "Role"
    nds_cfg_preset_set_priority addRole 19
