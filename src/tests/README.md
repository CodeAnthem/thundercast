...
Feature suites: `src/app/tests/`, `src/app/settingsManager/tests/`, `src/app/bundle/tests/`, `src/git/tests/`, `src/install/tests/`, `src/tools/tests/`.
...
Interactive prompt walk (`uiSmoke`) and real VM installs are not commit gates.
