...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# Date:          Created: 2026-08-18 | Modified: 2026-09-01
# Description:   Ask catalog Git URL; list and pick .nds/actions
# ==================================================================================================

# Description: Prompt for CAST_REPO_URL (required; no ThunderCast default).
# Unattended: CAST_REPO_URL / NDS_CAST_REPO_URL must already be set.
# Returns:
# - 0 when a URL is set
nds_cast_ui_ask_catalog() {
    ...
    if nds_mode_is_unattended; then
        [[ -n "$current" ]] || {
            error "Unattended remoteAction requires CAST_REPO_URL or NDS_CAST_REPO_URL"
            return 1
        }
    ...
    nds_ui_b ""
    nds_ui_b "Git repo that contains YOUR .nds/actions (not this ThunderCast repo)."
    nds_ui_b "addFleetHost and toolkit are fleet action packs — pick them from the main menu."
    nds_ui_b "There is no default URL — point at your leaf or a dedicated catalog."
    nds_ui_b "A public HTTPS catalog clones with no key."
    nds_ui_b ""
