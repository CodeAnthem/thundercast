...
# NDS - App CLI helpers
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# Date:          Created: 2026-07-29 | Modified: 2026-09-02
...
nds_app_session_cli_showHelp() {
    printf 'Usage: nds/src/app/main.sh [options]\n\n'
    printf 'Options:\n'
    ...
    printf '  --action NAME    Enter action NAME directly (e.g. installFlake, addFleetHost, toolkit)\n'
    ...
    printf '  NDS_GIT_PERSIST_ACCESS  true|false — keep SSH keys + tcast on the installed machine\n'
}
