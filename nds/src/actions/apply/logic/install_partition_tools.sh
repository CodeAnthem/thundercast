#!/usr/bin/env bash
# ==================================================================================================
# NDS - Disk partitioning public API (confirm UI + disko shot caller)
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
nds_partition_is_disk_ready_to_format() {
    ...
    state=${ disk_probeState "$disk"; } || state="unknown"
    nds_install_ui_confirm_disk_format "$disk" "$state"
}

# Description: Run Disko with explicit partition parameters (confirm + step UI).
