#!/usr/bin/env bash
# ==================================================================================================
# NDS - Disk preparation (shot caller: steps + ctx → disk utility)
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
_nds_install_partition_disk() {
    ...
    if [[ "$use_encryption" == "true" ]]; then
        disk_partition "$disk" "$use_encryption" "$uefi_mode" "_nds_install_format_luks"
    else
        disk_partition "$disk" "$use_encryption" "$uefi_mode"
    fi
}

# Description: Mount root + boot for NixOS installation (diag hook after).
# Arguments:
...
_nds_install_mount_filesystems() {
    ...
    nds_requireUtility disk || return 1
    disk_mountRoot "$use_encryption" /mnt || return 1
